...
import nuxt_plugin_plugin_578436cb from 'nuxt_plugin_plugin_578436cb' // Source: .\\components\\plugin.js (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"夢想家棒球隊 DREAMERS BASEBALL TEAM","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":"夢想家棒球隊，由一群熱愛打棒球的學生及社會人士組成，為高雄草野球聯盟一員"}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"style":[],"script":[]},
  ...
  if (typeof nuxt_plugin_plugin_578436cb === 'function') {
    await nuxt_plugin_plugin_578436cb(app.context, inject)
  }
